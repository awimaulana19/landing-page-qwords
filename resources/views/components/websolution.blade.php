<div class="sm:flex items-center sm:space-x-8 mt-36" style="margin-bottom: 150px">
    <div data-aos="fade-right" class="sm:w-1/2 relative">
        ...
        <h1 class="font-semibold text-2xl relative z-50 text-darken lg:pr-10">Bikin website impian <span
                class="text-yellow-500">dengan mudah disini hanya 1jutaan</span></h1>
        <p class="py-5 lg:pr-32">Bikin website impian include paket hosting Indonesia terbaik hanya 1 jutaan
            Jasa pembuatan website profesional untuk Perusahaan, Bisnis & UKM. Bikin Website Impian dengan mudah
            di sini, desain website elegan dan mudah dikelola
        </p>
        <a href="#" class="underline">Lihat Selengkapnya</a>
    </div>
    <div data-aos="fade-left" class="sm:w-1/2 relative mt-10 sm:mt-0">
        ...
        <img class="rounded-xl z-40 relative"
            src="https://qwords.com/v2/wp-content/themes/qwords/assets/images/illustrations/bw.webp" alt="">
        <button
